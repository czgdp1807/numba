...
@lower_builtin("array.sort", types.Array, types.IntegerLiteral,
               types.StringLiteral)
...
@lower_builtin("array.argsort", types.Array, types.IntegerLiteral,
               types.StringLiteral)
@lower_builtin(np.argsort, types.Array, types.IntegerLiteral,
               types.StringLiteral)
